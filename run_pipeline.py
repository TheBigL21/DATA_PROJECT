...
def main():
    ...
    if not args.skip_cleaning:
        run_command(
            ['python3', 'data/data_clean.py', str(imdb_dir), str(output_dir)],
    ...
    run_command(
        ['python3', 'src/data_processing/extract_country_fast.py', str(imdb_dir), str(output_dir)],
    ...
    if not args.skip_tmdb:
        ...
        run_command(
            ['python3', 'src/data_processing/fetch_tmdb_data.py',
    ...
    run_command(
        ['python3', 'src/data_processing/transform_imdb_data.py', str(output_dir), str(processed_dir)],
    ...
    if not args.skip_interactions:
        run_command(
            ['python3', 'src/data_processing/generate_synthetic_interactions.py',
    ...
    run_command(
        ['python3', 'src/models/collaborative_filtering.py',
    ...
    run_command(
        ['python3', 'src/models/cooccurrence_graph.py',
         str(interactions_parquet), str(models_dir)],
    ...
    # Import and test recommendation engine
